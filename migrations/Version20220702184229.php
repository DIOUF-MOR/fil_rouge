 ...
 */
final class Version20220702184229 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit_commande DROP INDEX UNIQ_47F5946EF347EFB, ADD INDEX IDX_47F5946EF347EFB (produit_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit_commande DROP INDEX IDX_47F5946EF347EFB, ADD UNIQUE INDEX UNIQ_47F5946EF347EFB (produit_id)');
    }
}
